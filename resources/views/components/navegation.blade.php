<header class="bg-white px-6 shadow dark:bg-slate-900">
    ...
    <div id="mobile-menu" class="hidden space-y-1 border-t pb-3 pt-2 dark:border-slate-500">
        <a href="{{ route("welcome") }}"
            class="block rounded-md  px-3 py-2 {{ request()->routeIs("welcome") ? "text-white bg-sky-500" : "text-slate-700 transition-colors hover:bg-sky-500 hover:text-white dark:text-slate-400 dark:hover:text-white" }}">
            Home
        </a>
        <a href="{{ route('posts.index') }}"
            class="block rounded-md  px-3 py-2 {{ request()->routeIs("posts.*") ? "text-white bg-sky-500" : "text-slate-700 transition-colors hover:bg-sky-500 hover:text-white dark:text-slate-400 dark:hover:text-white" }}">
            Blog
        </a>
        <a href="{{ route('about') }}"
            class="block rounded-md  px-3 py-2 {{ request()->routeIs("about") ? "text-white bg-sky-500" : "text-slate-700 transition-colors hover:bg-sky-500 hover:text-white dark:text-slate-400 dark:hover:text-white" }}">
            About
        </a>

        <a href="{{ route('contact') }}"
            class="block rounded-md  px-3 py-2 {{ request()->routeIs("contact") ? "text-white bg-sky-500" : "text-slate-700 transition-colors hover:bg-sky-500 hover:text-white dark:text-slate-400 dark:hover:text-white" }}">
            Contact
        </a>
    </div>
</header>